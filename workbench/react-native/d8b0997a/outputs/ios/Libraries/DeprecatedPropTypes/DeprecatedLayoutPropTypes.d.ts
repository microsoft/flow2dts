...
/*[FLOW2DTS - Warning] This type was an exact object type in the original Flow source.*/
{
  ...
  borderStartWidth: typeof ReactPropTypes.number;
  borderEndWidth: typeof ReactPropTypes.number;
  ...
  flex: typeof ReactPropTypes.number;
  flexGrow: typeof ReactPropTypes.number;
  flexShrink: typeof ReactPropTypes.number;
  flexBasis: React$PropType$Primitive<number | string>;
  aspectRatio: typeof ReactPropTypes.number;
  zIndex: typeof ReactPropTypes.number;
