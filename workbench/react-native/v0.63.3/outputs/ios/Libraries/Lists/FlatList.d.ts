...
declare class FlatList<ItemT> extends $2.PureComponent<Props<ItemT>, {}> {
   ...
   * `getItemLayout` prop.
   */
  scrollToItem(params: { animated?: null | undefined | boolean; item: ItemT; viewPosition?: number }): void
   ...
   */
  scrollToOffset(params: { animated?: null | undefined | boolean; offset: number }): void
   ...
   */
  getNativeScrollRef():
    | (null | undefined | $2.ElementRef<typeof $3>)
    | (null | undefined | $2.ElementRef<ScrollViewNativeComponentType>)
  getScrollableNode(): any
  setNativeProps(props: { [$f2tKey: string]: unknown }): void
