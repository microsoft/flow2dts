...
declare class AssetSourceResolver {
  ...
  asset: PackagerAsset;
  constructor: (serverUrl: null | undefined | string, jsbundleUrl: null | undefined | string, asset: PackagerAsset) => void;
...
declare const $f2tExportDefault: typeof AssetSourceResolver;
