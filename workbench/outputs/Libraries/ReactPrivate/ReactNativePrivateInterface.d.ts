...
declare type RCTEventEmitter = typeof RCTEventEmitter$f2tTypeof;
import ReactNativeViewConfigRegistry$f2tTypeof from "../Renderer/shims/ReactNativeViewConfigRegistry";
declare type ReactNativeViewConfigRegistry = typeof ReactNativeViewConfigRegistry$f2tTypeof;
import TextInputState$f2tTypeof from "../Components/TextInput/TextInputState";
declare type TextInputState = typeof TextInputState$f2tTypeof;
...
declare type deepDiffer = typeof deepDiffer$f2tTypeof;
import deepFreezeAndThrowOnMutationInDev$f2tTypeof from "../Utilities/deepFreezeAndThrowOnMutationInDev";
declare type deepFreezeAndThrowOnMutationInDev = typeof deepFreezeAndThrowOnMutationInDev$f2tTypeof;
import flattenStyle$f2tTypeof from "../StyleSheet/flattenStyle";
declare type flattenStyle = typeof flattenStyle$f2tTypeof;
import ReactFiberErrorDialog$f2tTypeof from "../Core/ReactFiberErrorDialog";
declare type ReactFiberErrorDialog = typeof ReactFiberErrorDialog$f2tTypeof;
