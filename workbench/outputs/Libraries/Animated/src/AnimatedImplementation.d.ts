...
declare const AnimatedAddition;
declare const AnimatedDiffClamp;
declare const AnimatedDivision;
declare const AnimatedInterpolation;
declare const AnimatedModulo;
declare const AnimatedMultiplication;
declare const AnimatedNode;
declare const AnimatedProps;
declare const AnimatedSubtraction;
declare const AnimatedValue;
declare const AnimatedValueXY;
declare const createAnimatedComponent;
