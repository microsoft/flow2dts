...
declare type ComponentProvider = () => React$ComponentType;
declare type ComponentProviderInstrumentationHook = (component: ComponentProvider, scopedPerformanceLogger: IPerformanceLogger) => React$ComponentType;
...
declare type WrapperComponentProvider = ($f2t1: any) => React$ComponentType;
