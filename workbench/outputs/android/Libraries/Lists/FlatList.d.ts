...
declare type VirtualizedListProps = $2<$4>;
...
declare class FlatList<ItemT> extends $2.PureComponent<Props<ItemT>, void> {
   ...
   */
  getNativeScrollRef: () => (null | undefined | $2<$3>) | (null | undefined | $2<ScrollViewNativeComponentType>);
...
declare const $f2tExportDefault: $TypeOf<typeof FlatList>;
