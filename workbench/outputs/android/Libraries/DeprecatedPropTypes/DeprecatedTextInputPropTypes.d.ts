...
typeof $2 & {
   ...
   * @platform ios
   */
  enablesReturnKeyAutomatically: $3.bool;
   ...
   */
  onSelectionChange: $3.func;

  /**
   * Callback that is called when the text input's submit button is pressed.
   * Invalid if `multiline={true}` is specified.
   */
  onSubmitEditing: $3.func;
   ...
   * @platform ios
   */
  scrollEnabled: $3.bool;

  /**
   * If `true`, the text input obscures the text entered so that sensitive text
   * like passwords stay secure. The default value is `false`. Does not work with 'multiline={true}'.
   */
  secureTextEntry: $3.bool;
   ...
   * @platform ios
   */
  clearTextOnFocus: $3.bool;

  /**
   * If `true`, all text will automatically be selected on focus.
   */
  selectTextOnFocus: $3.bool;
   ...
   * @platform android
   */
  inlineImageLeft: $3.string;

  /**
   * Padding between the inline image, if any, and the text input itself.
   * @platform android
   */
  inlineImagePadding: $3.number;
   ...
   * @platform ios
   */
  rejectResponderTermination: $3.bool;
