...
declare class MyClass1 extends React.Component<{}> {
  member: React.Component<{}>
}
declare interface MyInterface1 extends React.Component<{}> {
  member: React.Component<{}>
}

declare class MyClass2 extends React.Component<{}> {
  member: React.Component<{}>
}

declare interface MyInterface2 extends React.Component<{}> {
  member: React.Component<{}>
}
